REM cscript C:\Windows\System32\slmgr.vbs /ipk NPPR9-FWDCX-D2C8J-H872K-2YT43
REM cscript C:\Windows\System32\slmgr.vbs /skms kms.catqu.com
...
REM reg add "HKU\Default_User\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v ¡°PreInstalledAppsEnabled" /t REG_DWORD /d 0x00000000 /f
REM reg add "HKU\Default_User\Software\Microsoft\Windows\CurrentVersion\ContentDeliveryManager" /v ¡°OemPreInstalledAppsEnabled" /t REG_DWORD /d 0x00000000 /f
...
dism /online /Enable-Feature /FeatureName:ClientForNFS-Infrastructure /FeatureName:NFS-Administration /NoRestart /FeatureName:ServicesForNFS-ClientOnly
...
REM wget -P C:\ansible http://gallery.technet.microsoft.com/scriptcenter/2d191bcd-3308-4edd-9de2-88dff796b0bc/file/41459/25/PSWindowsUpdate.zip

REM wget -P C:\ansible http://slproweb.com/download/Win32OpenSSL_Light-1_0_1h.exe
REM C:\ansible Win32OpenSSL_Light-1_0_1h.exe /silent /verysilent /sp- /suppressmsgboxes
REM wget -P C:\ansible http://download.tuxfamily.org/notepadplus/6.4.5/npp.6.4.5.Installer.exe
REM C:\ansible npp.6.4.5.Installer.exe /S

REM wget http://10.144.152.235/nfs/isos/sysprep/windows10.0-kb4533002-x64.msu -O C:\ansible\windows10.0-kb4533002-x64.msu
...
REM wget -P C:\ansible http://the.earth.li/~sgtatham/putty/latest/x86/putty.exe
REM wget -P C:\ansible http://the.earth.li/~sgtatham/putty/latest/x86/pscp.exe

REM Dism++
wget http://10.144.152.235/nfs/isos/sysprep/Dism++10.1.1000.100_2d2bf466baca088c4b35248f5a7316f4e00cac0b.zip -O C:\ansible\Dism++10.1.1000.100.zip
